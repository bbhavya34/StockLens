...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors duration-150 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-emerald text-neutral-950 hover:bg-emerald/90 shadow-[0_0_0_1px_rgba(16,185,129,0.4)]",
        secondary: "bg-white/[0.06] text-foreground border border-border-strong hover:bg-white/[0.1]",
        outline: "border border-border-strong bg-transparent hover:bg-white/[0.05]",
