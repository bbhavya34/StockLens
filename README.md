...
RSI, SMA/EMA, MACD, momentum, volatility, trend

Fundamental Agent

Earnings, valuation, growth, margins, leverage, returns

News Agent

News collection, event detection, sentiment

Risk Agent

Drawdown, volatility, liquidity, leverage, concentration

Research Agent

Cross-domain reasoning and final synthesis

Explainability Engine

Maps conclusions back to supporting evidence
